...
public interface AgendamentoControllerDoc {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Busca realizada com sucesso, retornando os agendamentos correspondentes"),
            @ApiResponse(responseCode = "422", description = "O termo de busca deve conter pelo menos 3 caracteres")
    })
